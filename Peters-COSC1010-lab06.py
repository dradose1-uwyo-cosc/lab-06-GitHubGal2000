...
least = 100000
least_letters = ()
for letter, value in occurance_dict.items():
    if value > most:
        most = value
        most_letters = letter
    if value < least:
        least = value
        least_letters = letter



# Output: each letter and its corresponding occurrence in alphabetical order

for letter in sorted(set(random_string)):
    occurance_dict[letter] = 0
...
print(f"The letter that occurred the most is {most_letters}")
print("*"*75)
# Output which letter occurred the least 

print(f"The letter that occurred the least is {least_letters}")
print("*"*75)
